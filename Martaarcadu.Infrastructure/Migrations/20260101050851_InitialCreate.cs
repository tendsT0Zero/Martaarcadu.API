        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAgreedTermPolicy = table.Column<bool>(type: "bit", nullable: false),
                    TermPolicyUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubscriptionPlanBenefits_SubscriptionPlans_SubscriptionPlanId",
                        column: x => x.SubscriptionPlanId,
                        principalTable: "SubscriptionPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserServiceType",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserServiceType", x => new { x.ServiceTypesId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserServiceType_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserServiceType_ServiceTypes_ServiceTypesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserServiceType_UsersId",
                table: "ApplicationUserServiceType",
                column: "UsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPlanBenefits_SubscriptionPlanId",
